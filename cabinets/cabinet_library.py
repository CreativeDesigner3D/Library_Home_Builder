...
class Base_Door_Cabinet(data_cabinets.Standard_Cabinet):
    ...
    def __init__(self):
        ...
        self.exterior = data_cabinet_exteriors.Doors()
...
class Drawer_Cabinet(data_cabinets.Standard_Cabinet):
    ...
    def __init__(self):
        self.carcass = data_cabinet_carcass.Base_Advanced()
        self.interior = None
        self.exterior = data_cabinet_exteriors.Drawers()
...
class Splitter_Cabinet(data_cabinets.Standard_Cabinet):
    ...
    def __init__(self):
        ...
        self.splitter.exterior_1 = data_cabinet_exteriors.Doors()
        ...
        self.splitter.exterior_2 = data_cabinet_exteriors.Doors()
